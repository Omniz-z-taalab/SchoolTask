...
import '../../home_Screens/admin_home/admin_home.dart';
import '../../home_Screens/perant_screen/perant_home.dart';
import '../../home_Screens/school_home/school_home.dart';
import 'admin_login.dart';

class AdminRegisterScr extends StatefulWidget {
  const AdminRegisterScr({Key? key}) : super(key: key);

  @override
  State<AdminRegisterScr> createState() => _AdminRegisterScrState();
}

class _AdminRegisterScrState extends State<AdminRegisterScr> {
        ...
        child: BlocConsumer<AuthSchoolCubit, AuthSchoolState>(
          listener: (context, state) {
            if (state is CreateUserSuccess) {
              ...
              if(state.model!.status == 'Parent'){
                CacheHelper.saveData(key: 'user', value: state.model!.status);
                Navigator.push(context, MaterialPageRoute(builder: (_)=> PerantHomeScr()));

              }else{
                CacheHelper.saveData(key: 'user', value: 'Admin');
                Navigator.push(context, MaterialPageRoute(builder: (_)=> AdmenHomeScr()));
              }
            }
...
//           cub.userRegister(email, phone, password, name)
