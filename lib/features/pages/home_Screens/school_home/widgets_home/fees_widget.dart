            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const Center(child: Text('Add Fees',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20),)),
                  ...
                  const Padding(
                    padding: EdgeInsets.only(left: 20.0),
                    child: Align(alignment:Alignment.centerLeft,child: Text('Fees',style: TextStyle(color: Colors.white),)),
                  ),
                  SizedBox(height: 5,),
                  FormBotton(passwoedController,'Fees Name',false),
                  SizedBox(height: 20,),
                  Next(context)
                ],
              ),
